...
export default function Hero({ onOpenSos, onOpenDiagnostics, onScrollToSection }: HeroProps) {
  ...
  return (
    <section id="hero" className="relative bg-white text-gray-900 py-16 lg:py-24 overflow-hidden">
      {/* Subtle Grid Texture Background */}
      <div className="absolute inset-0 opacity-[0.02] pointer-events-none" 
           style={{ backgroundImage: "radial-gradient(#12151b 1px, transparent 1px)", backgroundSize: "24px 24px" }} />
      
      {/* Decorative Radial glow */}
      <div className="absolute top-1/4 right-1/4 w-96 h-96 bg-diagnostic/5 rounded-full blur-3xl pointer-events-none" />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          <div className="lg:col-span-7 flex flex-col space-y-8">
            <div className="inline-flex items-center space-x-2 bg-teal-50 border border-teal-100 px-3.5 py-1.5 rounded-full w-fit">
              <Shield className="h-4 w-4 text-teal-600" />
              <span className="font-mono text-xs text-teal-800 font-medium tracking-wider uppercase">
                AI-Powered OBD-II Diagnostic Network
              </span>
            </div>

            <h1 className="font-display font-bold text-4xl sm:text-5xl lg:text-6xl tracking-wide uppercase leading-tight text-gray-900">
              Your car, <span className="text-signal">fully diagnosed</span> <br className="hidden sm:inline" /> before it fails.
            </h1>

            <p className="font-sans text-gray-600 text-lg max-w-xl leading-relaxed font-light">
            ...
            <div className="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4">
              ...
              <button
                ...
                className="bg-white border border-gray-300 hover:border-gray-900 text-gray-800 font-display font-bold text-base tracking-wider uppercase px-8 py-4 rounded-lg flex items-center justify-center space-x-2 transition-all cursor-pointer"
              >
            ...
            {/* Statistics Row */}
            <div className="border-t border-gray-100 pt-8 mt-4 grid grid-cols-3 gap-4">
              <div className="flex flex-col">
                <span className="font-mono text-2xl sm:text-3xl font-bold text-gray-900 tracking-tight">12,000+</span>
                <span className="font-display text-xs text-gray-500 uppercase tracking-wider mt-1">Vehicles Serviced</span>
              </div>
              <div className="flex flex-col">
                <span className="font-mono text-2xl sm:text-3xl font-bold text-gray-900 tracking-tight">450+</span>
                <span className="font-display text-xs text-gray-500 uppercase tracking-wider mt-1">Verified Garages</span>
              </div>
              <div className="flex flex-col">
                <div className="flex items-center space-x-1">
                  <span className="font-mono text-2xl sm:text-3xl font-bold text-gray-900 tracking-tight">4.9</span>
                  <Star className="h-4 w-4 fill-amber-400 text-amber-400 inline" />
                </div>
                <span className="font-display text-xs text-gray-500 uppercase tracking-wider mt-1">Google Rating</span>
              </div>
            </div>
          </div>
          ...
          <div className="lg:col-span-5 flex justify-center">
            <div className="w-full max-w-md bg-white border border-gray-200 rounded-2xl p-6 shadow-xl relative overflow-hidden transition-all duration-300 hover:border-diagnostic/50 hover:shadow-2xl">
              
              {/* Glass Glare */}
              <div className="absolute -top-1/2 -left-1/2 w-full h-full bg-gray-50/5 transform rotate-12 pointer-events-none" />
              
              {/* Device Header */}
              <div className="flex items-center justify-between border-b border-gray-100 pb-4 mb-4">
                <div className="flex items-center space-x-2">
                  <Cpu className="h-5 w-5 text-diagnostic" />
                  <span className="font-display text-sm font-bold tracking-wider uppercase text-gray-900">mCarFix HUD v4.1</span>
                </div>
                <div className="flex items-center space-x-2">
              ...
              {/* Screen Display Area */}
              <div className="bg-gray-950 border border-gray-900 rounded-xl p-5 font-mono text-sm space-y-4 shadow-inner relative">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="bg-white/5 border border-white/5 p-2.5 rounded-lg">
                ...
                <div className="bg-black/60 border border-white/5 rounded-lg p-3 h-28 overflow-y-auto text-3xs leading-relaxed text-gray-400 select-all space-y-1">
              ...
              <div className="mt-5 flex justify-between items-center">
                <button
                  ...
                  className={`w-full ${hudStatus === "SCANNING" ? 'bg-gray-100 text-gray-400 cursor-not-allowed' : 'bg-gray-50 border border-gray-200 hover:border-signal text-signal hover:bg-signal/5'} font-display font-bold uppercase tracking-wider text-xs py-3 rounded-lg flex items-center justify-center space-x-2 transition-all cursor-pointer`}
                >
              ...
              <div className="mt-3 text-center">
                <button 
                  ...
                  className="text-xs font-mono text-gray-500 hover:text-signal transition-colors underline decoration-dotted"
                >
